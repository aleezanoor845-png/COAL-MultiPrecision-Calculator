...
; Multiplies one digit by another digit and applies carry.
; Input: AL = first digit, BL = second digit, BH = carry
...
; Adds one partial product digit into the result array.
...
; Returns EAX = 1 if either number is zero.
IsZeroInput PROC
    cmp num1Len, 1
    jne checkNum2
...
; Removes extra leading zeroes from the stored product.
...
; Multiplies num1 and num2 using reversed digit arrays.
